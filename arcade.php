...
echo '<span><a href="arcade_play.php?id='.$line['game_id'].'" title="'.$lang_arcade['played'].' '.$line['game_played'].'"><img align="top" src="games/images/_'.$line['game_image'].'" alt="" /></a>&nbsp;<a href="arcade_play.php?id='.$line['game_id'].'" title="'.$lang_arcade['played'].' '.$line['game_played'].'">'.$line['game_name'].' ('.$line['game_played'].')</a><p></span>';				$i++;
			...
			<td align="left" cellspacing="0" style="padding: 0px 0px 0px 0px; margin-top: 0px; margin-left: 0px; margin-right: 0px; margin-bottom: 0px; border:none;"><a href="arcade_play.php?id=<?php echo $randg['game_id']?>"><?php echo $randg['game_name']?></a></td>
			</tr>
			</table>
			</fieldset>
			</td>
	...
	<div class="blockform">
		<h2><span><?php echo ''.$lang_arcade['Arcade Games'].'';?></span></h2>
		<div class="box">
			<div class="inbox">
				<table cellspacing="0">
				<thead>
					<tr>
						...
						<th class="tc2" scope="col" width="25%" nowrap="nowrap"><?php echo $lang_arcade['highscores']?></th>
						<th class="tc3" scope="col" width="25%" nowrap="nowrap"><?php echo $lang_arcade['Your highscore']?></th>
						<th class="tcr" scope="col" width="25%" ><?php echo $lang_arcade['How to play']?></th>
					</tr>
				</thead>
				<tbody>
