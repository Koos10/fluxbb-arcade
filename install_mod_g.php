...
function install()
{
	...
	// German game descriptions 
	$games = array(
		//game_name, game_filename, game_desc, game_image, game_width, game_height, game_cat
		array("Balloon Hunter", "balloonhunter", "Du musst versuchen mit Pfeil und Bogen Luftballons vom Himmel schiessen.<br />Keine leichte Aufgabe, denn die Windstärke ändert sich von Zeit zu Zeit.", "balloonhunter.jpg", 550, 400, 9),
		array("Breakit", "breakit", "Der Spieler muss mit einem Paddel den Ball im Spiel halten und die Steine aus dem Spielfeld entfernen.<br />Breakit ist sehr gute Breakout Umsetzung und bietet sehr gute Grafik und viel Abwechslung.", "breakit.jpg", 640, 480, 4),
		array("Diamond Mines", "diamondmine", "Diamond Mine ist ein klassisches Spiel, in dem Sie Reihen aus drei oder vier identischen Steinen aufbauen müssen.", "diamondmine.jpg", 550, 400, 3),
		array("Tetrollapse", "tetrollapse", "Bei dieser Tetris Variante muss man die vorhandenen Figuren beseitigen um ins nächste Level zu gelangen.<br />Ansonsten bleiben die Regeln wie gewohnt. Es gibt 33 verschiedene Level.", "tetrollapse.jpg", 640, 480, 3),
		array("Frogger", "frogger", "Bringe den Frosch sicher über die stark befahrene Straße und über den Fluss.<br />Der Frosch muss dabei auf der Straße Autos ausweichen und zur Überquerung eines Flusses treibende Äste als Plattformen nutzen.", "frogger.jpg", 400, 450, 1),
		array("Space Invaders", "invaders", "Dies ist das originalgetreue Abbild des 1978 erschienen Kult- spiels Space Invaders!<br /> Eine Horde von Aliens wandert den Bildschirm herunter. Je mehr Aliens abgeschossen werden, desto schneller bewegen sie sich.", "invaders.jpg", 520, 440, 1),
		array("Reel Gold", "reelgold", "Ziel des Spiel Reel Gold ist es in jedem Level soviele Goldstücke wie möglich mit deiner Seilwinde ans Tageslicht zu befördern.<br />Es können nur glänzende Klumpen geborgen werden. Habt ihr beim Einholen Kontakt mit einem Stein verliert ihr den Goldklumpen.", "reelgold.jpg", 550, 450, 4),
		array("Spank The Monkey", "spankmonkey", "Der Spieler muss per Maus mit der virtuelle Hand so schnell und hart wie möglich auf den Affen einschlagen.", "spankmonkey.jpg", 850, 400, 4),
		array("Speartoss Wheelchair", "speartoss", "Wie weit kannst Du den Speer werfen?", "speartoss.jpg", 625, 360, 9),
		array("Speartoss 5 Shots", "speartoss5shots", "Du hast 5 Versuche um den Speer soweit wie möglich zu werfen. Alle Versuche werden dann am Ende addiert.", "speartoss5shots.jpg", 625, 360, 9),
	);
